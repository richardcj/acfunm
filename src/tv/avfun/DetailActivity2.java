...
public class DetailActivity2 extends SherlockActivity implements OnItemClickListener, OnClickListener {

    private static final String TAG        = DetailActivity2.class.getSimpleName();
    ...
    private class RequestDetailTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(Boolean result) {
            if (result) {
                ...
                tvBtnPlay.setOnClickListener(DetailActivity2.this);
                ...
                mLoadView.setOnClickListener(DetailActivity2.this);
            }
    ...
    private void initview() {
        ...
        mInflater = LayoutInflater.from(DetailActivity2.this);
    ...
    private void startPlay(VideoPart item) {
        addToHistory();
        Intent intent = new Intent(DetailActivity2.this, SectionActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case R.id.menu_item_share_action_provider_action_bar:
            MobclickAgent.onEvent(DetailActivity2.this,"share");
            break;
        case R.id.menu_item_fov_action_provider_action_bar:
            handleFavorite(item);
            break;
        case R.id.menu_item_comment:
            Intent intent = new Intent(DetailActivity2.this, CommentsActivity.class);
            intent.putExtra("aid", aid);
            startActivity(intent);
            MobclickAgent.onEvent(DetailActivity2.this,"view_comment");
            break;
        }
        return true;
    }
    ...
    private void handleFavorite(MenuItem item) {
        if (isFavorite) {
            ...
            MobclickAgent.onEvent(DetailActivity2.this,"delete_favorite");
        } else {
            ...
            MobclickAgent.onEvent(DetailActivity2.this,"add_favorite");
        }
    }
    ...
    private OnStatusClickListener slistener = new OnStatusClickListener() {
        ...
        public void doViewDownloadInfo(String vid) {
            startActivity(new Intent(DetailActivity2.this,DownloadManActivity.class));
        }
        
        @Override
        public void doStartDownload(final View v, final VideoPart item) {
            
            if(!NetWorkUtil.isWifiConnected(DetailActivity2.this)){
        ...
        private void startDownload(final VideoPart item) {
            ...
            MobclickAgent.onEvent(DetailActivity2.this,"download");
